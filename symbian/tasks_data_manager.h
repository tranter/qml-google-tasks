...
/*
    ...
    void moveTask(
            ...
            const QString& prevTaskID,   const QString& parentID);
*/
    Q_INVOKABLE void deleteList(const QString& access_token, const QString& taskListID);
    Q_INVOKABLE void deleteTask(const QString& access_token, const QString& taskListID, const QString& taskID);
/*
